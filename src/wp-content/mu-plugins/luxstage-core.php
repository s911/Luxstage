...
add_action('acf/init', static function (): void {
    ...
    acf_add_local_field_group([
        ...
        'fields' => [
            ...
            luxstage_acf_text_field('field_luxstage_wattage', 'Wattage', 'wattage', 'e.g. 200W / 350W / 1200W', false),
            ...
            luxstage_acf_text_field('field_luxstage_channels', 'DMX Channels', 'channels', 'e.g. 16CH / 24CH / 36CH', false),
            [
...
(function($){
  $(function(){
    var box = $('#luxstage-gallery-metabox');
    if (!box.length) {
      return;
    }
    ...
    function render(ids){
      ...
      ids.forEach(function(id){
        ...
        a.fetch();
        var thumb = (a.get('sizes') && a.get('sizes').thumbnail) ? a.get('sizes').thumbnail.url : a.get('url');
        if (!thumb) {
          return;
        }
        var item = $('<div>', {
